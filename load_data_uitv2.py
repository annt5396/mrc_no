...
class SquadV2(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            datasets.SplitGenerator(name=datasets.Split.TRAIN, gen_kwargs={"filepath": '/home/annt/kbqa/reading-comprehension-service/dataset/train_dev_uitv2_add_dev_uitv2.json'}),
            datasets.SplitGenerator(name=datasets.Split.VALIDATION, gen_kwargs={"filepath": '/home/annt/kbqa/reading-comprehension-service/dataset/dev_trainv2_sb_dev.json'}),
                ...
                for paragraph in example["paragraphs"]:
                    ...
                    for qa in paragraph["qas"]:
                        ...
                        if type(qa["answers"]) is list:
                            answer_starts = [answer["answer_start"] for answer in qa["answers"][:1]]
                            answers = [answer["text"] for answer in qa["answers"][:1]]
                        else:
